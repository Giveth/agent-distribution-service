...
export const developmentConfig: AppConfig = {
  ...
  blockchain: {
    ...
    givgardenAddress: "0xd10BAC02a02747cB293972f99981F4Faf78E1626", // GIVgarden address for development
  ...
  discord: {
    ...
    feeThreshold: process.env.DISCORD_FEE_THRESHOLD || "1", // 1 POL minimum
